...
export default function Board() {
    ...
    const {
        states: {boards, workspace, selectedTask, openEditTask, setOpenEditTask},
    ...
    return (<Page style={{background: "white!important", "height": "fit-content"}}>
        <Line vertical={true}/>
        <AppBar/>
        ...
        <div style={{padding: "10px"}}>
            <div style={{width: "100%", display: "flex", overflowX: "auto"}}>
                ...
                <div style={{
                    ...
                    <div onClick={createNewBoard} className="clickable"
        ...
        <EditTaskPopup editTask={editTask} onClose={() => setOpenEditTask(false)} task={selectedTask}
                       open={openEditTask}/>
    </Page>);
}