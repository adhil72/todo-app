...
export default function ProfileImage(props:propsType & React.HTMLProps<HTMLDivElement>){
    return <div {...props} style={{width:props.size+"rem",height:props.size+"rem",...props.style, border:"solid 1px",borderRadius:"100%",borderColor:"grey",display:"flex",alignItems:"center",justifyContent:"center",background:"#bebebe"}}>
