        ...
        <div style={{padding:"20px"}}>
            {
                items.map(({name,icon},index)=> {
                    return <Button fullWidth={true} style={{display: "flex", fill: "#94A3B8", color: "#94A3B8", alignItems: "center",padding:"10px",justifyContent:"start",borderRadius:"15px",textTransform:"none"}}>
                        {icon}
